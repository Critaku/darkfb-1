...
echo $kuning"=================================================="
echo $hijau"=================================================="
echo $biru" Author    : Cyber Darknet Id        "
echo $biru" Facebook   : Randi Prtm     "
echo $biru" Github    : https://github.com/darkcyber91/darkfb  "
echo $biru" Whatsapp : (082171747514) "
echo $biru" Thanks To : Konvoi (Darknetteam) "
echo $merah"=================================================="
echo $kuning"=================================================="
echo $hijau"=================================================="
